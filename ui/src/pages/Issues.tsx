...
import { ISSUES_VIEW_STATE_KEY } from "../lib/issues-view-state";
...
export function Issues() {
  ...
  return (
    <IssuesList
      ...
      // Reset the persisted issue-page filter state after the closed-only view regression.
      viewStateKey={ISSUES_VIEW_STATE_KEY}
